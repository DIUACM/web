...
import { submitContact } from "@/lib/api/services/contact";
...
export function ContactForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      toast.success(result.message || "Your message has been received.");
      form.reset();
    } catch (error: unknown) {
      console.error("Error submitting form:", error);
      
      const { message, fieldErrors } = getApiErrorInfo(error);
